...
const MATERIALS: MaterialSeed[] = [
  {
    description: 'SSD Kingston 480GB A400',
    quantity: 1,
    unitCost: 35000,
    trackingCode: 'TS-PC0001',
    supplierEmail: 'ventas@techparts.com.ar',
  },
  {
  ...
  {
    description: 'Cable UTP Cat6 exterior 100m',
    quantity: 2,
    unitCost: 18000,
    trackingCode: 'TS-CAM003',
    supplierEmail: 'pedidos@cablesyredes.com.ar',
  },
  {
    description: 'Cámara Hikvision DS-2CD2047G2-LU 4MP',
    quantity: 6,
    unitCost: 65000,
    trackingCode: 'TS-CAM003',
    supplierEmail: 'info@seguridadtotal.com.ar',
  },
  {
    description: 'DVR Hikvision DS-7608NI-K2 8 canales',
    quantity: 1,
    unitCost: 120000,
    trackingCode: 'TS-CAM003',
    supplierEmail: 'info@seguridadtotal.com.ar',
  ...
  {
    description: 'Disco HDD WD Purple 2TB',
    quantity: 1,
    unitCost: 55000,
    trackingCode: 'TS-CAM003',
    supplierEmail: 'info@seguridadtotal.com.ar',
  ...
  {
    description: 'Fuente de alimentación TV LED 24"',
    quantity: 1,
    unitCost: 15000,
  ...
  {
    description: 'Cable eléctrico 2.5mm negro x 100m',
    quantity: 1,
    unitCost: 42000,
    trackingCode: 'TS-EL0005',
    supplierEmail: 'ventas@electrosuministros.com.ar',
  },
  {
    description: 'Cinta aisladora 3M Super 33+',
    quantity: 3,
    unitCost: 2500,
    trackingCode: 'TS-EL0005',
    supplierEmail: 'ventas@electrosuministros.com.ar',
  ...
  {
    description: 'Access Point Ubiquiti U6 Lite',
    quantity: 1,
    unitCost: 95000,
  ...
  {
    description: 'Cable UTP Cat6 azul 305m',
    quantity: 1,
    unitCost: 65000,
    trackingCode: 'TS-WF0006',
    supplierEmail: 'pedidos@cablesyredes.com.ar',
  ...
  {
    description: 'Conector RJ45 Cat6 (pack 100)',
    quantity: 1,
    unitCost: 8500,
    trackingCode: 'TS-WF0006',
    supplierEmail: 'pedidos@cablesyredes.com.ar',
  ...
  {
    description: 'Fuente ATX 650W 80+ Bronze',
    quantity: 1,
    unitCost: 52000,
  ...
  {
    description: 'Router WiFi 6 TP-Link AX73',
    quantity: 1,
    unitCost: 78000,
  ...
  {
    description: 'Nodo mesh TP-Link Deco X60 (pack 2)',
    quantity: 2,
    unitCost: 95000,
    trackingCode: 'TS-WF0010',
    supplierEmail: 'pedidos@cablesyredes.com.ar',
  ...
  {
    description: 'Panel LED 43" Samsung',
    quantity: 1,
    unitCost: 120000,
  ...
  {
    description: 'Cable eléctrico 4mm rojo x 100m',
    quantity: 1,
    unitCost: 55000,
  ...
  {
    description: 'Disyuntor diferencial bipolar 25A',
    quantity: 1,
    unitCost: 12000,
    trackingCode: 'TS-EL0012',
    supplierEmail: 'ventas@electrosuministros.com.ar',
  ...
  {
    description: 'Termica monopol. 16A',
    quantity: 1,
    unitCost: 5500,
    trackingCode: 'TS-EL0012',
    supplierEmail: 'ventas@electrosuministros.com.ar',
  ...
  {
    description: 'Caja de empalme 10x10cm',
    quantity: 4,
    unitCost: 1800,
    trackingCode: 'TS-EL0012',
    supplierEmail: 'ventas@electrosuministros.com.ar',
  ...
  {
    description: 'Aire comprimido 400ml',
    quantity: 2,
    unitCost: 2500,
    trackingCode: 'TS-MT0015',
    supplierEmail: 'ventas@techparts.com.ar',
  ...
  {
    description: 'DVR Hikvision DS-7204HUHI 4 canales',
    quantity: 1,
    unitCost: 90000,
    trackingCode: 'TS-CAM0016',
    supplierEmail: 'info@seguridadtotal.com.ar',
