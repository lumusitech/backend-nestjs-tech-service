...
export class Init1782509680956 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "users" ADD "commission" numeric(5,2) DEFAULT '5'`,
    );
    await queryRunner.query(`ALTER TABLE "users" ADD "experience" text`);
    await queryRunner.query(
      `ALTER TABLE "users" ADD "trustRating" numeric(2,1)`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."users_role_enum_old" AS ENUM('admin', 'technician')`,
    );
    await queryRunner.query(
