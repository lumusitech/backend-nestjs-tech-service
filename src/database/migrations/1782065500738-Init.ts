...
export class Init1782065500738 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TYPE "public"."notifications_type_enum" ADD VALUE 'pending_item.created'`,
    );
    await queryRunner.query(
      `ALTER TYPE "public"."notifications_type_enum" ADD VALUE 'pending_item.due_today'`,
    );
    await queryRunner.query(
      `ALTER TYPE "public"."notifications_type_enum" ADD VALUE 'pending_item.overdue'`,
    );
    await queryRunner.query(
      `ALTER TABLE "invoices" ADD CONSTRAINT "FK_903956a630ba453be61bb327f6a" FOREIGN KEY ("work_order_id") REFERENCES "work_orders"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "pending_items" ADD CONSTRAINT "FK_6bf51e7e63468a93075edcc8e8e" FOREIGN KEY ("assigned_to_id") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "pending_items" ADD CONSTRAINT "FK_414a6453b021decb2db04e9dbd5" FOREIGN KEY ("created_by_id") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "pending_items" DROP CONSTRAINT "FK_414a6453b021decb2db04e9dbd5"`,
    );
    await queryRunner.query(
      `ALTER TABLE "pending_items" DROP CONSTRAINT "FK_6bf51e7e63468a93075edcc8e8e"`,
    );
    await queryRunner.query(
      `ALTER TABLE "notifications" DROP CONSTRAINT "FK_9a8a82462cab47c73d25f49261f"`,
    );
    await queryRunner.query(
      `ALTER TABLE "invoices" DROP CONSTRAINT "FK_02781c49b25ceb502571f0315f6"`,
    );
    await queryRunner.query(
      `ALTER TABLE "invoices" DROP CONSTRAINT "FK_903956a630ba453be61bb327f6a"`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."notifications_type_enum_old" AS ENUM('work_order.created', 'work_order.status_changed', 'work_order.technician_assigned', 'task.created', 'task.completed', 'payment.created', 'payment.approved', 'payment.rejected')`,
    );
    await queryRunner.query(
